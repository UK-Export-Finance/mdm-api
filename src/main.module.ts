...
import { BODY_LOG_KEY, ACCESS_TOKEN_LOG_KEY, CLIENT_REQUEST_LOG_KEY, HEADERS_LOG_KEY, INCOMING_RESPONSE_LOG_KEY, OUTGOING_REQUEST_LOG_KEY } from '@ukef/modules/http/http.constants';
        ...
        pinoHttp: {
          ...
          redact: logKeysToRedact({
            ...
            incomingResponse: {
              ...
              bodyLogKey: BODY_LOG_KEY,
              accessTokenLogKey: ACCESS_TOKEN_LOG_KEY,
            },
            error: {
              logKey: 'err',
              sensitiveChildKeys: [
