...
export const mapProductConfig = (odsProductConfig: GetProductConfigOdsResponse): GetDomProductConfigResponse => {
  ...
  return {
    ...
    configuration: {
      commitmentDate: conf?.commitmentDate ?? NOT_APPLICABLE,
      ...
      participations: conf?.participations ?? NOT_APPLICABLE,
      scheduledRepayments: conf?.scheduledRepayments ?? NOT_APPLICABLE,
      nonCashObligations: conf?.nonCashObligations ?? NOT_APPLICABLE,
      cashObligations: conf?.cashObligations ?? NOT_APPLICABLE,
      accrualSchedule: conf?.accrualSchedule ?? NOT_APPLICABLE,
      pimOwner: conf?.pimOwner ?? NOT_APPLICABLE,
      riskRating: conf?.riskRating ?? NOT_APPLICABLE,
      preCreditPeriod: conf?.preCreditPeriod ?? NOT_APPLICABLE,
      creditPeriod: conf?.creditPeriod ?? NOT_APPLICABLE,
      lossGivenDefault: conf?.lossGivenDefault ?? NOT_APPLICABLE,
      provisionRate: conf?.provisionRate ?? NOT_APPLICABLE,
      forecastYear: conf?.forecastYear ?? NOT_APPLICABLE,
      bankRate: conf?.bankRate ?? NOT_APPLICABLE,
