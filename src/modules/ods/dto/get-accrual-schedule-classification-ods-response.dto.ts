...
export class GetAccrualScheduleClassificationOdsResponseDto {
  @ApiProperty({
    description: 'Accrual schedule classification type',
    example: EXAMPLES.ODS.ACCRUAL_SCHEDULE_CLASSIFICATION.classification_type,
  })
  readonly classification_type: string;

  @ApiProperty({
    description: 'Accrual schedule classification type code',
    example: EXAMPLES.ODS.ACCRUAL_SCHEDULE_CLASSIFICATION.classification_type_code,
  })
  readonly classification_type_code: string;

  @ApiProperty({
    description: 'Accrual schedule classification code',
    example: EXAMPLES.ODS.ACCRUAL_SCHEDULE_CLASSIFICATION.classification_code,
  })
  readonly classification_code: string;

  @ApiProperty({
    description: 'Accrual schedule classification description',
    example: EXAMPLES.ODS.ACCRUAL_SCHEDULE_CLASSIFICATION.classification_description,
  })
  ...
  @ApiProperty({
    ...
    example: EXAMPLES.ODS.ACCRUAL_SCHEDULE_CLASSIFICATION.classification_active_flag,
  })
